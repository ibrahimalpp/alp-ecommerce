...
import CardPreview from "./CardPreview"; // CardPreview bileşeni burada kullanılıyor
import { createOrder } from "../../../../actions/createOrder"; // Sipariş oluşturma işlemi
...
const CheckoutPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    clearCart();
    router.push('/success'); // Başarılı sipariş sonrası yönlendirme
  };
